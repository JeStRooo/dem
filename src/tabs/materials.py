...
COLUMNS = (
    "Тип", "Наименование", "Поставщик", "Количество в упаковке", "Описание", "Стоимость", "Кол-во на складе", "Минимальное допустимое количество", "Единица измерения"
)
    ...
    def load_data(self):
        ...
        with self.conn.cursor(pymysql.cursors.DictCursor) as cursor:
            ...
            SELECT 
                ...
                m.name as material_name,  -- Переименовываем, чтобы не было конфликта
                IFNULL(s.name, '') as supplier_name,  -- Явно указываем имя поля
                m.package_quantity, 
                m.description, 
                m.unit_price, 
                m.stock_quantity, 
